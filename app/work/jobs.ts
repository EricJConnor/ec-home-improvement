...
export const JOBS: Job[] = [
  { id: 'navy-kitchen', name: 'A navy and white kitchen', line: 'Farmhouse sink under the window, brass lantern and pulls, the counter running out to become the sill.', photos: ['p3634', 'p3633', 'p3635', 'p3637', 'p3586', 'p3638', 'p3639'] },
  ...
  { id: 'black-house', name: 'The rest of the black house', line: 'Same rowhouse: the entry and stair painted black around a leaded glass door, an accent wall, and three baths on slate with walnut and glass.', photos: ['p3201', 'p3204', 'p3196', 'p3143', 'p3144', 'p3198', 'p3211', 'p3212', 'p3199', 'p3206', 'p3194', 'p3192', 'p3200', 'p3195'] },
  ...
  { id: 'green-house', name: 'Green, olive and white', line: 'A whole house repainted: the living room and stair hall, an olive dining wall, a teal-tiled bath, the bedrooms in white.', photos: ['p2637', 'p2638', 'p2640', 'p2642', 'p2644', 'p2646', 'p2648', 'p2650', 'p2651', 'p2645'] },
  ...
  { id: 'yankee-chipper', name: 'The Yankee Chipper, from studs to service', line: 'A restaurant Eric owned and built himself: the partitions framed, the mahogany booths panelled and finished, the green banquette, the bar, the dining room set for service.', photos: ['p9498', 'p9508', 'p9565', 'p9592', 'p9648', 'p9567', 'p9568', 'p9604', 'p9603', 'p9650', 'p9649', 'p9651', 'p9644', 'p9694', 'p9688', 'p9555', 'p9554', 'p9702', 'p1003', 'p1002', 'p4427', 'p9698', 'p9696'] },
]
