/* The jobs on /work. Each is one project with the photographs of it that exist at page size
   ...
   order is Eric's (Sep 5): the navy kitchen, brick and beams, the black kitchen, the restaurant, then
   the rest. No shed: he painted that pool house and it did not photograph well. */
...
export const JOBS: Job[] = [
  ...
  { id: 'black-house', name: 'The rest of the black house', line: 'Same rowhouse: the entry and stair painted black around a leaded glass door, an accent wall, and three baths on slate with walnut and glass.', photos: ['p3201', 'p3204', 'p3196', 'p3143', 'p3211', 'p3199', 'p3206', 'p3194', 'p3192', 'p3200', 'p3195'] },
